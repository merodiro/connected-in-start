...
export default function Header() {
  ...
  return (
    <>
      <header className="p-4 flex items-center justify-between bg-card text-card-foreground shadow-lg border-b">
        ...
        <nav className="flex-1 p-4 overflow-y-auto">
          ...
          <div className="flex flex-row justify-between">
            <Link
              ...
              activeProps={{
                className:
                  'flex-1 flex items-center gap-3 p-3 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground transition-colors mb-2',
              }}
            >
              <StickyNote size={20} />
